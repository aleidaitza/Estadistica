...
# 2.3.- Cálculo de la moda para la variable especie y largo aleta
mfv(BD$especie) # categorica
mfv(BD$largo_aleta_mm) # numerica
# La moda de la variable especie es [1] "Adelie"
...
#El valor de la varianza es [1] 198.2214
# 2.- Cálculo de la desviación estándar
